...
Page({
  ...
  buy: function() {
    ...
    if (this.data.key_info == null || this.data.details == null || this.data.log_from == null || this.data.key_name == null || this.data.key_phone == null || this.data.log_to == null || this.data.time_log == null) {
      wx.showToast({
        title: '不能输入为空喔……',
        icon: 'none'
      })
