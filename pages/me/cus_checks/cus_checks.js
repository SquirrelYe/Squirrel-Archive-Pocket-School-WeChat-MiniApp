...
Page({
  ...
  data: {
    ...
    kind: '../../../photo/tangle_down.png', judge_kind: '1', in_color: '', out_color:'#07d811',submit_kind:'1',
    dis:'no',dis_kind:'no',display:'0',
    dis_search:'no',judge_search:'1',
    putong_color: '#f8f8f8', kuaidi_color: '#f8f8f8', waimai_color:'#f8f8f8',
    judge_quick:'1',empty_price:'0',
  ...
  filter_reset:function(){
    this.setData({
      putong_color: '#ffb366', kuaidi_color: '#f8f8f8', waimai_color: '#f8f8f8',
      judge_quick: '1'
    });
    this.setData({
      txt: '', 
